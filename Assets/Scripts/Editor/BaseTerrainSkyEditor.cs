...
public class BaseTerrainSkyEditor : Editor
{
    ...
    protected SerializedProperty cloudStartSize;
    ...
    protected SerializedProperty cloudMinSpeed;
    protected SerializedProperty cloudMaxSpeed;
    protected SerializedProperty cloudRange;
    ...
    private void DrawTerrainCloudParameters()
    {
        ...
        if (showClouds)
        {
            ...
            EditorGUILayout.PropertyField(cloudStartSize, new GUIContent("Cloud Size"));
            ...
            EditorGUILayout.Space();
            EditorGUILayout.Slider(cloudMinSpeed, 0f, 5f, new GUIContent("Min Speed"));
            EditorGUILayout.Slider(cloudMaxSpeed, 0f, 5f, new GUIContent("Max Speed"));
            EditorGUILayout.IntSlider(cloudRange, 1, 5000, new GUIContent("Range Travelled"));
